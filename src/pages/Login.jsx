    ...
    try {
      ...
      dispatch({
        ...
        payload: {
          user: result.userData,
          token: "lk765l&$%^J;7457$%J2457;$J&#$^%&",
          role: result.userData.role, // Added role here
        },
      });
          ...
          <form className="py-4 md:py-0" onSubmit={handleSubmit}>
            <div className="mb-5 px-5">
              <input
                ...
                onChange={handleInputChange}
                required
                className="w-full py-3 border-b border-solid border-lime-600 focus:outline-none focus:border-lime-600 text-[22px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer"
              />
            </div>
